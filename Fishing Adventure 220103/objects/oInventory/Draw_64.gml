...
if instance_exists(oFishGuide)
	{
		...
		if oFishGuide.sida = -2 && oFishGuide.menuchoice = 0 
		{
			for (var i = 0; i < INVENTORY_SLOTS; i += 1)
			{
				...
				if (inventory[i] != -1)
					{
						if place = i
						{
							...
							draw_text_color(oFishGuide.x+70,oFishGuide.y+78,string(global.fisharray[inventory[i],4]),c_black,c_black,c_black,c_black,oFishGuide.alpha)
							...
							draw_text_color(oFishGuide.x+70,oFishGuide.y+175,string(scrStringWrap(global.fisharray[inventory[i],6],130,"\n",true)) + string("\nWorth ") + string(global.fisharray[inventory[i],3]) + string(" gold."),c_black,c_black,c_black,c_black,oFishGuide.alpha)
							...
							{
								sprite_set_offset(global.fisharray[inventory[i],1],sprite_get_width(global.fisharray[inventory[i],1]) / 2,sprite_get_height(global.fisharray[inventory[i],1]) /2)
								draw_sprite_ext(global.fisharray[inventory[i],1],0,oFishGuide.x+70,oFishGuide.y+135,4,4,0,c_white,oFishGuide.alpha)		
								sprite_set_offset(global.fisharray[inventory[i],1],global.fisharray[inventory[i],7],global.fisharray[inventory[i],8])
							...
							{
								sprite_set_offset(global.fisharray[inventory[i],2],sprite_get_width(global.fisharray[inventory[i],2]) / 2,sprite_get_height(global.fisharray[inventory[i],2]) /2)
								draw_sprite_ext(global.fisharray[inventory[i],2],0,oFishGuide.x+70,oFishGuide.y+135,4,4,0,c_white,oFishGuide.alpha)		
								sprite_set_offset(global.fisharray[inventory[i],1],global.fisharray[inventory[i],9],global.fisharray[inventory[i],10])	
							}
						}
					}	
				...
				if (inventory[i] != -1)
				{
					...
					{
						sprite_set_offset(global.fisharray[inventory[i],1],sprite_get_width(global.fisharray[inventory[i],1]) / 2,sprite_get_height(global.fisharray[inventory[i],1]) /2)
						draw_sprite_ext(global.fisharray[inventory[i],1],0,xx+12,yy+12,1,1,0,c_white,oFishGuide.alpha)
						sprite_set_offset(global.fisharray[inventory[i],1],global.fisharray[inventory[i],7],global.fisharray[inventory[i],8])
						//sprite_set_offset(global.fisharray[inventory[i]+1,1],sprite_get_width(global.fisharray[inventory[i]+1,1]) / 2,sprite_get_height(global.fisharray[inventory[i]+1,1]) /2)
					...
					{
						sprite_set_offset(global.fisharray[inventory[i],2],sprite_get_width(global.fisharray[inventory[i],2]) / 2,sprite_get_height(global.fisharray[inventory[i],2]) /2)
						draw_sprite_ext(global.fisharray[inventory[i],2],0,xx+12,yy+12,1,1,0,c_white,oFishGuide.alpha)
						sprite_set_offset(global.fisharray[inventory[i],2],global.fisharray[inventory[i],9],global.fisharray[inventory[i],10])	
					}
						scrDrawSet(fTextboxSmall,c_black,fa_right)
						scrTextOutline(xx+23,yy+14,stacks[i],50,oFishGuide.alpha,global.color[25],global.color[19])
