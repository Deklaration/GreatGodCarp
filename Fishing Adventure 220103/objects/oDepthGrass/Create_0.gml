...
//Mode 1 variables
grass_radius = 64; //Radius around the object for creating the grass
//----------------
...
//General variables
grass_number = 100//20000; //Number of grass sprites inside the room
grass_sprite = sDepthGrass; //Sprite used for the grass
...
pattern_size = 5//5; //Sway pattern size
