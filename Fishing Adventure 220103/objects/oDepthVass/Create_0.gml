...
//Mode 1 variables
grass_radius = 12; //Radius around the object for creating the grass
//----------------
...
//General variables
grass_number = 6//20000; //Number of grass sprites inside the room
grass_sprite = sDepthVass; //Sprite used for the grass
