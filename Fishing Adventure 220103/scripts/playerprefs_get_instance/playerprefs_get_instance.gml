/// @description  playerprefs_get_instance();
/// @returns {instance} The obj_playerpref instance
function playerprefs_get_instance() {
	/**
	...
	if (instance_exists(obj_playerprefs)) {
		return obj_playerprefs;
	}
	return instance_create_depth(0,0,0,obj_playerprefs);
